...
| --- | --- | --- | --- |
| IH-1 | Persistence Inventory And Repository Boundaries | Inventory of remaining mock/in-memory state and repository interfaces | Completed PN block |
| IH-2 | PostgreSQL Persistence And Migrations | Metadata, process, audit and operational tables with migrations | IH-1 |
...
| SEC-3 | Secrets And Service Accounts | Secrets outside git and controlled integration identities | SEC-1 |
