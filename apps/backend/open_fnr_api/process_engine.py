...
PROCESS_DEFINITIONS: tuple[ProcessDefinition, ...] = (
    ...
    ProcessDefinition(
        ...
        version=1,
        status=ProcessDefinitionStatus.DEPLOYED,
        deployment_id="flowable-dev-deploy-20260528-029",
        source_path="processes/store-management/store_task_process.bpmn20.xml",
        owner_role="Store Operations",
    ),
    ProcessDefinition(
        key="true_inventory_confidence_decision",
        name="True inventory confidence decision",
        artifact_type=ProcessArtifactType.DMN,
        version=1,
        status=ProcessDefinitionStatus.DEPLOYED,
        deployment_id="flowable-dev-deploy-20260528-029",
        source_path="processes/store-management/true_inventory_confidence_decision.dmn.xml",
        owner_role="Inventory Data Owner",
    ),
    ProcessDefinition(
        key="store_task_priority_decision",
        name="Store task priority decision",
        artifact_type=ProcessArtifactType.DMN,
        version=1,
        status=ProcessDefinitionStatus.DEPLOYED,
        deployment_id="flowable-dev-deploy-20260528-029",
        source_path="processes/store-management/store_task_priority_decision.dmn.xml",
        owner_role="Store Operations",
    ),
    ProcessDefinition(
        key="inventory_mismatch_case",
        name="Inventory mismatch case",
        artifact_type=ProcessArtifactType.CMMN,
        version=1,
        status=ProcessDefinitionStatus.DEPLOYED,
        deployment_id="flowable-dev-deploy-20260528-029",
        source_path="processes/store-management/inventory_mismatch_case.cmmn.xml",
        owner_role="Inventory Data Owner",
    ),
    ProcessDefinition(
    ...
    ProcessDefinition(
        ...
        version=1,
        status=ProcessDefinitionStatus.DEPLOYED,
        deployment_id="flowable-dev-deploy-20260528-026",
        source_path="processes/capacity/capacity_smoothing_process.bpmn20.xml",
        owner_role="Supply Chain Manager",
    ),
    ProcessDefinition(
        key="capacity_overload_decision",
        name="Capacity overload decision",
        artifact_type=ProcessArtifactType.DMN,
        version=1,
        status=ProcessDefinitionStatus.DEPLOYED,
        deployment_id="flowable-dev-deploy-20260528-026",
        source_path="processes/capacity/capacity_overload_decision.dmn.xml",
        owner_role="Supply Chain Manager",
    ),
    ProcessDefinition(
        key="order_shift_priority_decision",
        name="Order shift priority decision",
        artifact_type=ProcessArtifactType.DMN,
        version=1,
        status=ProcessDefinitionStatus.DEPLOYED,
        deployment_id="flowable-dev-deploy-20260528-026",
        source_path="processes/capacity/order_shift_priority_decision.dmn.xml",
        owner_role="Store Operations",
    ),
    ProcessDefinition(
        key="capacity_overload_case",
        name="Capacity overload case",
        artifact_type=ProcessArtifactType.CMMN,
        version=1,
        status=ProcessDefinitionStatus.DEPLOYED,
        deployment_id="flowable-dev-deploy-20260528-026",
        source_path="processes/capacity/capacity_overload_case.cmmn.xml",
        owner_role="Supply Chain Manager",
    ),
    ProcessDefinition(
        key="shelf_space_review_process",
        name="Shelf space review process",
        artifact_type=ProcessArtifactType.BPMN,
        version=1,
        status=ProcessDefinitionStatus.DEPLOYED,
        deployment_id="flowable-dev-deploy-20260528-025",
        source_path="processes/shelf-space/shelf_space_review_process.bpmn20.xml",
        owner_role="Category Manager",
    ),
    ProcessDefinition(
        key="display_capacity_decision",
        name="Display capacity decision",
        artifact_type=ProcessArtifactType.DMN,
        version=1,
        status=ProcessDefinitionStatus.DEPLOYED,
        deployment_id="flowable-dev-deploy-20260528-025",
        source_path="processes/shelf-space/display_capacity_decision.dmn.xml",
        owner_role="Store Operations",
    ),
    ProcessDefinition(
        key="direct_to_shelf_decision",
        name="Direct-to-shelf decision",
        artifact_type=ProcessArtifactType.DMN,
        version=1,
        status=ProcessDefinitionStatus.DEPLOYED,
        deployment_id="flowable-dev-deploy-20260528-025",
        source_path="processes/shelf-space/direct_to_shelf_decision.dmn.xml",
        owner_role="Store Operations",
    ),
    ProcessDefinition(
        key="shelf_capacity_exception_case",
        name="Shelf capacity exception case",
        artifact_type=ProcessArtifactType.CMMN,
        version=1,
        status=ProcessDefinitionStatus.DEPLOYED,
        deployment_id="flowable-dev-deploy-20260528-025",
        source_path="processes/shelf-space/shelf_capacity_exception_case.cmmn.xml",
        owner_role="Category Manager",
    ),
    ProcessDefinition(
        key="purchase_proposal_process",
        name="Purchase proposal process",
        artifact_type=ProcessArtifactType.BPMN,
        version=1,
        status=ProcessDefinitionStatus.DEPLOYED,
        deployment_id="flowable-dev-deploy-20260528-024",
        source_path="processes/procurement/purchase_proposal_process.bpmn20.xml",
        owner_role="Supply Chain Manager",
    ),
    ProcessDefinition(
        key="supplier_selection_decision",
        name="Supplier selection decision",
        artifact_type=ProcessArtifactType.DMN,
        version=1,
        status=ProcessDefinitionStatus.DEPLOYED,
        deployment_id="flowable-dev-deploy-20260528-024",
        source_path="processes/procurement/supplier_selection_decision.dmn.xml",
        owner_role="Procurement Planner",
    ),
    ProcessDefinition(
        key="supplier_share_exception_decision",
        name="Supplier share exception decision",
        artifact_type=ProcessArtifactType.DMN,
        version=1,
        status=ProcessDefinitionStatus.DEPLOYED,
        deployment_id="flowable-dev-deploy-20260528-024",
        source_path="processes/procurement/supplier_share_exception_decision.dmn.xml",
        owner_role="Procurement Planner",
    ),
    ProcessDefinition(
        ...
        status=ProcessDefinitionStatus.DEPLOYED,
        deployment_id="flowable-dev-deploy-20260528-024",
        source_path="processes/procurement/supplier_constraint_case.cmmn.xml",
        owner_role="Supply Chain Manager",
    ),
    ProcessDefinition(
    ...
    ProcessDefinition(
        ...
        version=1,
        status=ProcessDefinitionStatus.DEPLOYED,
        deployment_id="flowable-dev-deploy-20260528-021",
        source_path="processes/process-governance/process_change_management_process.bpmn20.xml",
        owner_role="BPM Owner",
    ),
    ProcessDefinition(
        key="process_change_risk_decision",
        name="Process change risk decision",
        artifact_type=ProcessArtifactType.DMN,
        version=1,
        status=ProcessDefinitionStatus.DEPLOYED,
        deployment_id="flowable-dev-deploy-20260528-021",
        source_path="processes/process-governance/process_change_risk_decision.dmn.xml",
        owner_role="Process Owner",
    ),
    ProcessDefinition(
        key="process_incident_case",
        name="Process incident case",
        artifact_type=ProcessArtifactType.CMMN,
        version=1,
        status=ProcessDefinitionStatus.DEPLOYED,
        deployment_id="flowable-dev-deploy-20260528-021",
        source_path="processes/process-governance/process_incident_case.cmmn.xml",
        owner_role="Process Owner",
    ),
    ProcessDefinition(
...
TASKS: tuple[ProcessTask, ...] = (
    ...
    ProcessTask(
        ...
        process_instance_id="proc-feature-build-20260528-001",
        process_key="feature_build_process",
        name="Validate feature mart build",
        status=TaskStatus.OPEN,
        assigned_role="Data Science Owner",
        candidate_roles=("Data Science Owner", "Data Engineer"),
        available_actions=("validate", "publish", "request_rebuild", "comment"),
        sla_due_at=datetime(2026, 5, 28, 19, 0, tzinfo=timezone.utc),
        created_at=datetime(2026, 5, 28, 14, 30, tzinfo=timezone.utc),
        business_key="fm-20260528-001",
    ),
    ProcessTask(
