...
- UI-элементы, влияющие на бизнес-действия, фильтры, статусы, метрики, графики, таблицы и формы, имеют help-сноски со ссылками на постановку задачи и связанные BPMN/DMN/CMMN или бизнес-процессы;
