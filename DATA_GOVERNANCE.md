...
Детальные технические и процессные требования к интеграционной загрузке фактических продаж, остатков, товаров в пути и открытых заказов описаны в [DATA_INTEGRATION_SPEC.md](DATA_INTEGRATION_SPEC.md).
